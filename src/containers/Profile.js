    ...
    details(){
        ...
        return (
            <View style={styles.details}>
                <Image source={require('../images/user_icon.png')} style={styles.image}/>
    ...
    return (
      <Container>
          <View style={styles.card}>
            ...
            <Text style={styles.text}>Voitto-%: {Math.round( ((user.games.filter(g => g.gameWon).length/user.games.length)*100)/100)*100}%</Text>
