  ...
  render() {
    return (
      <Container>
        ...
        <View style={{width:'60%'}}>
          <LoginButton onPress={() => this.fbLogin()} title='Kirjaudu Facebookilla' color='#3b5998' border='#8b9dc3' icon={<FontAwesome name="facebook-square" size={60} color="white" />}/>
          <LoginButton onPress={() => this.props.navigation.navigate('Login')} title='Kirjaudu tunnuksilla' color='#ed1e29' border="#f4424b" icon={<MaterialCommunityIcons name="login" size={60} color="white"/>} />
          <LoginButton onPress={() => {this.props.navigation.navigate('Register')}} title='Rekisteröidy' color='gray' border="#b0b4b7" icon={<MaterialCommunityIcons name="account-key" size={60} color="white"/>} />
        </View>
        )}
      </Container>
    )
